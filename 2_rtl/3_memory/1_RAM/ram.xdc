...
#set_property PACKAGE_PIN V13 [get_ports {d_out[8]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[8]}]
#set_property PACKAGE_PIN V3 [get_ports {d_out[9]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[9]}]
#set_property PACKAGE_PIN W3 [get_ports {d_out[10]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[10]}]
#set_property PACKAGE_PIN U3 [get_ports {d_out[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[11]}]
#set_property PACKAGE_PIN P3 [get_ports {d_out[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[12]}]
#set_property PACKAGE_PIN N3 [get_ports {d_out[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[13]}]
#set_property PACKAGE_PIN P1 [get_ports {d_out[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_out[14]}]
#set_property PACKAGE_PIN L1 [get_ports {d_out[15]}]					
