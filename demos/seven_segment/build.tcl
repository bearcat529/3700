# Load sources
read_verilog [ glob src/*.v example/*.v]
read_xdc SevenSegmentDemo.xdc

# Run Synthesis

synth_design -top SevenSegmentDemo -part xc7a35tcpg236-1
...
# Make bitstream
write_bitstream -force SevenSegmentDemo.bit
